...
class AllureReporter {
    ...
    start(err, args) {
        ...
        console.log(`### Iniciando execução de - ${suiteName} ###`);
    ...
    assertion(err, args) {
        ...
        console.log(`#### in assertion ${stepName} ####`);
    ...
    beforeItem(err, args) {
        // somente um  running item
        if (!this.runningItems.length){
            ...
            const cenario_pm_item = pm_item;
            cenario_pm_item.name = subSuites.join();

            this.runningItems.push({
                name: fullName,
                allure_test: allure_test,
                pm_item: cenario_pm_item
            })
        }
    }
    ...
    item(err, args) {
        ...
        if (bodyModeProp === "raw") {
            ...
            console.log('body mode: ', bodyModePropObj);
        } else {
            bodyModePropObj = ""
        }
        ...
        // não apagar o acumulador running item
